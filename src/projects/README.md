...
The explorer supports configuration via `delphi-devkit.projects.excludePatterns` for excluding files/folders from the project search.
...
```json
{
  "delphi-devkit.delphiProjects.excludePatterns": [
    "**/__history/**",
    "**/3rd_Party/**",
    "!**/3rd_Party/be/**",
    "**/backup/**"
